 ...
 * @author Leonardo
 */
public class SimpleTerrainShader extends ShaderProgram {
    
    private static final int MAX_LIGHTS = 0;

    private static final String VERTEX_FILE = 
            "res/shaders/terrainShader/simpleTerrainVertexShader.txt";
    private static final String FRAGMENT_FILE =
            "res/shaders/terrainShader/simpleTerrainFragmentShader.txt";
    ...
    protected void getAllUniformLocations() {
        ...
        // Get time location
        locationGameTime = super.getUniformLocation("tAnim");
    }
    ...
    // Loads game time into shader for animation/morping
    public void loadGameTime(float gameTime) {
        super.loadFloat(locationGameTime, gameTime);
    }
